                                ...
                                >
                                    <div style={{ display: 'flex', gap: 16 }}>
                                        <div style={{ width: 80, height: 80, backgroundColor: '#f0f0f0', borderRadius: 8, overflow: 'hidden' }}>
                                            {product.image ? <img src={`${process.env.REACT_APP_URL_IMAGES}/${product.image}`} alt={product.name} style={{ width: '100%', height: '100%', objectFit: 'cover' }} /> : <span style={{ color: '#aaa', fontSize: 12 }}>Không có</span>}
                                        </div>
                                        <div>
                    ...
                    <Descriptions bordered column={1} size="middle">
                        ...
                        <Descriptions.Item label="Ảnh">
                            {viewingProduct.image ? (
                                <img
                                    src={`${process.env.REACT_APP_API_URL}/${viewingProduct.image}`}
                                    alt="product"
                                    style={{
                                        width: 150,
                                        height: 150,
